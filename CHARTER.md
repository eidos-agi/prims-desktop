...
PATH `prims-desktop` is an XPC client. Named mach service plus codesign
peer check; do not archive `NSXPCListenerEndpoint`. FDA prove is the
in-app Messages path (Settings “Connected” / first rows), not piped
